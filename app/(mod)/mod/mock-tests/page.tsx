		...
		switch (activeTab) {
			...
			case "scheduled":
				return mockTests.filter(
					(test) =>
						test.scheduledDate && new Date(test.scheduledDate) > new Date(),
				);
			default:
				return mockTests;
		}
			...
			<Tabs defaultValue="all" onValueChange={setActiveTab}>
				...
				<TabsContent value={activeTab}>
					<Card>
						<CardHeader>
							<CardTitle>
								{activeTab.charAt(0).toUpperCase() + activeTab.slice(1)} Mock
								Tests
							</CardTitle>
							<CardDescription>
								Manage your {activeTab === "all" ? "" : activeTab} mock tests
								here. You can create, edit, and delete tests.
							</CardDescription>
						</CardHeader>
						<CardContent>
							{loading ? (
												...
												<TableCell className="text-right">
													<div className="flex justify-end gap-2">
														<Button
															...
															size="icon"
															onClick={() =>
																router.push(`/mod/mock-tests/${test.id}`)
															}
														>
														...
														<Button
															...
															size="icon"
															onClick={() =>
																router.push(`/mod/mock-tests/${test.id}/edit`)
															}
														>
															...
															<AlertDialogContent>
																<AlertDialogHeader>
																	...
																	<AlertDialogDescription>
																		...
																		permanently delete the mock test and all
